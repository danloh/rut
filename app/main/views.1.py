...
@main.route('/item/<id>', methods=['GET'])  
def item(id):
...
@main.route('/comment/p/<id>', methods=['GET','POST'])  
@login_required
...
@main.route('/comment/i/<id>', methods=['GET','POST'])  
@login_required
...
@main.route('/review/i/<id>', methods=['GET','POST'])  
@login_required
def add_review(id):
    item = Items.query.get_or_404(id)   # item 's id
    form = ReviewForm()
...
@main.route('/review/edit/<id>', methods=['GET','POST'])  
@login_required
def edit_review(id):
...
@main.route('/delcommt/<id>', methods=['GET','POST'])  
@login_required
def del_comment(id):
...
## Moderate comments
@main.route('/disablecomment/<id>', methods=['GET','POST'])  
@login_required
...
@main.route('/enablecommt/<id>', methods=['GET','POST'])  
@login_required
@permission_required(Permission.MOD_COMMENT)
...
@main.route('/morecommt/u/<id>', methods=['GET','POST'])  
@login_required
...
@main.route('/morecommt/i/<id>', methods=['GET','POST'])  
@login_required
...
@main.route('/mycommt/i/<id>', methods=['GET','POST'])  
@login_required
def mycomment_i(id):
    item = Items.query.get_or_404(id)   # item 's id 
...
@main.route('/morecommt/p/<id>', methods=['GET','POST'])  
@login_required
...
@main.route('/morepost/u/<id>', methods=['GET','POST'])  
@login_required
def morepost(id):
    user = Users.query.get_or_404(id)   # user 's id 
